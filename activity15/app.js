...
const renderNav = () => {
    ...
    */
    ...
    .querySelectorAll("a[data-page]").forEach(link => {
...
const renderAssignmentRow = (list) => {
    if (list.length === 0) {
...
const renderCurrentPage = async () => {
    ...
    //To do: hydrate or populate data
    hydrateDashboard();
...
const loadPageHTML = async (pageId) => {
    if (pages[pageId])
        return pages[pageId]();
...
const hydrateDashboard = () => {
    ...
    document.getElementById("assignments-table-body").innerHTML = renderAssignmentRow(plotAssignments);
